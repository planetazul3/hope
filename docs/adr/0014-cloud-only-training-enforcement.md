...
1. All model training must be performed exclusively in Google Colab or Kaggle by uploading `data/ticks.csv` and executing `notebooks/colab_training.ipynb` or `notebooks/kaggle_training.ipynb`.
